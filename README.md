...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-okta-keyman-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-okta-keyman-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-okta-keyman` can be installed with:

```
conda install aws-okta-keyman
```

It is possible to list all of the versions of `aws-okta-keyman` available on your platform with:
